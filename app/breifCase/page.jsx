            ...
            <div className='forContainerPadding'>             
                ...
                <Row>
                    <Col md={8} className='coloumnsforTablet'>
                        ...
                        <div className='mt-2 text-justify'>
                            <p>This portfolio consultation service is designed to provide a birds eye view of the client&apos;s currently invested portfolio. It refers to a professional financial service that assists individuals or institutions in managing their investment portfolios. It provides a better and differentiated experience for our clients with an overall view of the current portfolio expectations.</p>
                        </div>
                        <div>
                            <h2>What you get :</h2>
                            <div style={{ alignItems: 'left', display: 'flex', justifyContent: 'left' }}>
                            ...
                            <div className='mt-3'>
                                <div className='whatugetContainer'>
                                    <CheckCircleOutlinedIcon /><p>We will provide portfolio suggestion single time.</p>
                                </div>
                                <div className='whatugetContainer'>
                    ...
                    <Col md={4} className='coloumnsforTablet'>
                        ...
                        <div className='PricingbtnContainer'>
                            <Button className='pricingBtn'>₹ 5000/- 1-5-Stocks</Button>
                            <Button className='pricingBtn'>₹15000/- 6-10-Stocks</Button>
                            <Button className='pricingBtn'>₹25000/- 11+ Stocks</Button>
                ...
                <Row>
                    <Col md={8} className='coloumnsforTablet'>
                        ...
                        <div>
                            <RequestCallForm tag={'P-BREIF CASE'} />
                        </div>
                    </Col>
                    <Col md={4} className='coloumnsforTablet'>
