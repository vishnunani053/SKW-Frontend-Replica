...
const MagicMomentsPage = () => {
    const tag = 'F-MAGIC MOMENT'
    return (
        <div>
            <Container>
                        ...
                        <Col md={8} className='coloumnsforTablet'>
                            <div className='magicIntro'>
                                ...
                                <div style={{ alignItems: 'left', display: 'flex', justifyContent: 'left' }}>
                                    <div style={{ borderColor: ' #e99004', borderWidth: '3px', borderRadius: '5px', width: '40px', marginBottom: '1px', marginLeft: '1px' }}></div>
                                </div>
                            </div>
                ...
                <div className='forContainerPadding'>
                    <Row>
                        <Col md={8} className='coloumnsforTablet'>
                            ...
                            <div>
                                <RequestCallForm tag={'P-MAGIC MOMENT'} />
                            </div>
                        </Col>
                        <Col md={4} className='coloumnsforTablet'>
...
export default MagicMomentsPage