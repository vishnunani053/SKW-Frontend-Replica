...
const WealthCompassPage = () => {
    const tag = 'F-WEALTH COMPASS'
    return (
        <div>
            <Container>
                <div className='forContainerPadding'>
                    ...
                    <Row>
                        <Col md={8} className='coloumnsforTablet'>
                            ...
                            <div className='mt-2 text-justify'>
                                <p>Get your portfolio on the right track or clear your doubts regarding your finances with our one-time consultancy service. We will align your investment portfolio with your goals so that there is maximum compounding. This service is ideal for DIY (do it yourself) people who want professional advice to keep their investment in right track.</p>
                            </div>
                            <div>
                                <h2>What you get :</h2>
                                <div style={{ alignItems: 'left', display: 'flex', justifyContent: 'left' }}>
                                ...
                                <div className='mt-3'>
                                    <div className='whatugetContainer'>
                                        <CheckCircleOutlinedIcon /><p>We will understand your requirement over Virtual Meeting.</p>
                                    </div>
                                    <div className='whatugetContainer'>
                                        <CheckCircleOutlinedIcon /><p>We will suggest you the recommendation on your portfolio in next virtual meeting.</p>
                                    </div>
                                    <div className='whatugetContainer'>
                    ...
                    <Row>
                        <Col md={8} className='coloumnsforTablet'>
                            ...
                            <div>
                                <RequestCallForm tag={'P-WEALTH COMPASS'} />
                            </div>
                        </Col>
                        <Col md={4} className='coloumnsforTablet'>
...
export default WealthCompassPage