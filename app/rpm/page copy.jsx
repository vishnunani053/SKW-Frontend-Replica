...
import { Row, Col, Table, Form, Label, Input, FormGroup, Button } from "reactstrap"
...
const RpmPage = () => {
  ...
  return (
    <div>
      <div className='rpmMainContainer'>
        ...
        <div className='formrpmScoreContainer'>
          ...
          <Form>
            ...
            <Row className='mt-4'>
              ...
              {/* <Col md={6}>
                <Label className='formQuestion'>2. What is your annual income range ?*</Label>
                <FormGroup check className='mt-3'>
                  <Input
                    ...
                    value={0.5}
                    onChange={() => {
                      handleRadioChange('radio2', 0.5);
                      calculateScore();
                    }}
                  />
                  <Label check className='formLabel'>
                ...
                <FormGroup check className='mt-3'>
                  <Input
                    ...
                    value={1}
                    onChange={() => {
                      handleRadioChange('radio2', 1);
                      calculateScore();
                    }}
                  />
                  <Label check className='formLabel'>
                    Between Rs. 5 Lakh to Rs. 10 Lakh
                  </Label>
                </FormGroup>
                <FormGroup check className='mt-3'>
                  <Input
                    ...
                    value={2}
                    onChange={() => {
                      handleRadioChange('radio2', 2);
                      calculateScore();
                    }}
                  />
                  <Label check className='formLabel'>
                    Between Rs. 10 Lakh to Rs. 20 Lakh
                  </Label>
                </FormGroup>
                <FormGroup check className='mt-3'>
                  <Input
            ...
            {/* <Row>
              <Col md={6}>
                <Label className='formQuestion'>3. What is your primary source of income?*</Label>
                <FormGroup check className='mt-3'>
                  <Input
                    name="radio3"
                    type="radio"
              ...
              <Col md={6}>
                <Label className='formQuestion'>4. What is your secondary source of Income?*</Label>
                <FormGroup check className='mt-3'>
                  <Input
                    name="radio4"
                    type="radio"
            ...
            <Row>
              <Col md={6}>
                <Label className='formQuestion'>5. What is your proposed Investment amount?*</Label>
                <FormGroup check className='mt-3'>
                  <Input
                    name="radio5"
                    type="radio"
              ...
              <Col md={6}>
                <Label className='formQuestion'>6. What is the value of your current portfolio?*</Label>
                <FormGroup check className='mt-3'>
                  <Input
                    name="radio6"
                    type="radio"
            ...
            <Row>
              <Col md={6}>
                <Label className='formQuestion'>7. What is the value of your borrowings/ liabilities as on date?*</Label>
                <FormGroup check className='mt-3'>
                  <Input
                    name="radio7"
                    type="radio"
              ...
              <Col md={6}>
                <Label className='formQuestion'>8.What percentage of your income is used in paying of your debt/ EMI’s? *</Label>
                <FormGroup check className='mt-3'>
                  <Input
                    name="radio8"
                    type="radio"
            ...
            <Row>
              <Col md={6}>
                <Label className='formQuestion'>9. What is your investment objective?*</Label>
                <FormGroup check className='mt-3'>
                  <Input
                    name="radio9"
                    type="radio"
                  />
                  <Label check className='formLabel'>
                    Targeting high investment returns, willing to accept high risk including full capital loss
                  </Label>
                </FormGroup>
                <FormGroup check className='mt-3'>
                  <Input
                  ...
                  />
                  <Label check className='formLabel'>
                    Targeting high investment returns, willing to accept moderate risk with some capital loss
                  </Label>
                </FormGroup>
                <FormGroup check className='mt-3'>
                  <Input
                  ...
                  />
                  <Label check className='formLabel'>
                    Targeting medium investment returns, willing to accept less risk with less loss of capital
                  </Label>
                </FormGroup>
                <FormGroup check className='mt-3'>
                  <Input
                  ...
                  />
                  <Label check className='formLabel'>
                    Targeting low investment returns, willing to accept minimum loss of capital
                  </Label>
                </FormGroup>
              </Col>
              <Col md={6}>
                <Label className='formQuestion'>10. What would you do if your investment amount is making loss ?*</Label>
                <FormGroup check className='mt-3'>
                  <Input
                    name="radio10"
                    type="radio"
                ...
                <FormGroup check className='mt-3'>
                  ...
                  />
                  <Label check className='formLabel'>
                    Wait for the investment amount to recover
                  </Label>
                </FormGroup>
                <FormGroup check className='mt-3'>
                  <Input
                  ...
                  />
                  <Label check className='formLabel'>
                    Exit the loss making investment and enter new investment immediately
                  </Label>
                </FormGroup>
                <FormGroup check className='mt-3'>
                  <Input
                  ...
                  />
                  <Label check className='formLabel'>
                    Exit the loss making investment and wait for next good opportunity
                  </Label>
                </FormGroup>
              </Col>
            </Row> */}
            ...
            <Row>
              <Col>
                <h4 style={{color:'#666666',fontSize:'30px',fontFamily:'sans-serif'}}>YOUR SCORE IS {finalScore}</h4>
