...
const MagicCombo = () => {
    ...
    return (
        <div>
            <div className='MainMagicContainer'>
                <Row>
                    <Col>
                        <div>
                ...
                <Row>
                    <Col md={8} className='coloumnsforTablet'>
                        ...
                        <div className='mt-2 text-justify'>
                            <p>This service is suitable for traders who wish to diversify their products on the basis of short term and long term investments. In this service the client can choose any of our two products based on the risk profile and investment amount.
                            </p>
                        </div>
                        <div>
                            <h2>What you get :</h2>
                            ...
                            <div className='mt-3'>
                                <div className='whatugetContainer'>
                                    <CheckCircleOutlinedIcon /><p>We will provide 18-20 recommendation in a month.
</p>
                                </div>
                                <div className='whatugetContainer'>
                    ...
                    <Col md={4} className='coloumnsforTablet'>
                        ...
                        <div className='PricingbtnContainer'>
                            <Button className='pricingBtn'>₹ 100000/- 3 Months</Button>
                        </div>
